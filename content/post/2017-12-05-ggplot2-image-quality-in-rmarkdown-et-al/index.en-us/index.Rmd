...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%"}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, dev="CairoPNG", fig.width = 4, out.width = "70%"}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, dev="svg", fig.width = 4, out.width = "70%"}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%", fig.retina=1}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%", fig.retina=2}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%", fig.retina=3}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%", fig.retina=4}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
...
```{r fig.asp=891/483, fig.width = 4, out.width = "70%", fig.retina=5}
diamonds %>%
  ggplot(aes(x = carat, fill = cut)) + 
  geom_density(color = NA) +
  facet_wrap(vars(cut), ncol = 1) +
